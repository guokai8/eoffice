---
title: "An R package for exporting and importing graphics and tables to Microsoft Office"
author:
- name: Kai Guo
  affiliation: 
...
## set tempdir used for the tutorial or you can set the work directory 
currentwd <- getwd()
setwd(tempdir())
plot(mtcars$mpg, mtcars$disp, col = factor(mtcars$cyl), pch = 20)
topptx(filename = "mtcars.pptx") 
## filename accept full path 
